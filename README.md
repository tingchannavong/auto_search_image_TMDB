# auto_search_image_TMDB
This application automates the process of downloading images from TMDB using my personal movie list in order to use it to post a review on my instagram account.
...
My python script automates the following processes / pain points:
